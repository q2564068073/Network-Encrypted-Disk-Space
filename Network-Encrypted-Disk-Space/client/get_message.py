...
# 创建群
  def create_group(self, group_name, group_key):
    message = 'create_group' + '|' + group_name + '|' + group_key
    return message


  # 登入群
  def login_group(self, group_name, group_key):
    message = 'login_group' + '|' + group_name + '|' + group_key
    return message


  # 查看群文件列表
  def get_group_list(self, group_name):
    message = 'get_group_list' + '|' + group_name
    return message


  # 上传群文件
  def upload_group(self, group_name, file_name):
    message = 'upload_group' + '|' + group_name + '|' + file_name
    return message


  # 下载群文件
  def download_group(self, group_name, file_name):
    message = 'download_group' + '|' + group_name + '|' + file_name
    return message